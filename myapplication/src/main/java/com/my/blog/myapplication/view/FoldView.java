...
public class FoldView extends View {
    ...
    private void drawBitmaps(Canvas canvas) {
         ...
         */
        canvas.save();
        canvas.clipPath(mRegionCurrent.getBoundaryPath());
        canvas.clipPath(regionNext.getBoundaryPath(), Region.Op.DIFFERENCE);
         ...
         */
        canvas.save();
        canvas.clipPath(regionFold.getBoundaryPath());
         ...
         */
        canvas.save();
        canvas.clipPath(regionNext.getBoundaryPath());
        canvas.clipPath(regionFold.getBoundaryPath(), Region.Op.DIFFERENCE);
