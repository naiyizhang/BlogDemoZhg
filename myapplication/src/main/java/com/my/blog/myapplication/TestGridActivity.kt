...
import com.my.blog.myapplication.TestGridActivity.Images.TAG

class TestGridActivity : AppCompatActivity() {

    object Images {
        internal const val TAG = "TestGridActivity"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val gridView = findViewById<GridView>(R.id.girdview)

        val list = mutableListOf<String>()
        for(i in 0..100){
            list.add("Item $i")
        }
        gridView.adapter = ArrayAdapter<String>(this,R.layout.simple_item,list)

        gridView.setOnScrollListener(object :OnScrollListener{
            ...
            override fun onScroll(
                ...
                Log.e(TAG, "onScroll: $firstVisibleItem,$visibleItemCount")
            }
        })
